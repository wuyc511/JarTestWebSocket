...
//    long tt2;
//    /**
//     * 有参构造方法(Parametric construction method:), It's function is to tran
//     * @param uri request uri
//     * @param countDownLatch Thread controller
//     * @param map Encapsulate the data into the map
...
//        System.out.println("A message has been received from websocket :=====:" + message);
//        logger.info("A message has been received from websocket:===:" + message);
//
//        /**------------------------------------------------------------/
//         |                   对消息作进一步的确认，避免阻塞发生          |
//         /============================================================*/
